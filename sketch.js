...
function setup() {
  ...
  rules = createSprite(250,250,width,height);
...
if(striker.isTouching (blackCoin1)||striker.isTouching (blackCoin2)||striker.isTouching (blackCoin3)||striker.isTouching (blackCoin4)||striker.isTouching (blackCoin5)||striker.isTouching (blackCoin6)||striker.isTouching (blackCoin7)||striker.isTouching (blackCoin8)||striker.isTouching (blackCoin9)
||striker.isTouching (whiteCoin1)||striker.isTouching (whiteCoin2)||striker.isTouching (whiteCoin3)||striker.isTouching (whiteCoin4)||striker.isTouching (whiteCoin5)||striker.isTouching (whiteCoin6)||striker.isTouching (blackCoin7)||striker.isTouching (whiteCoin8)||striker.isTouching (whiteCoin9)
||striker.isTouching(pinkCoin)){
  strikingCoinSound.play();
...
if(gameState==="start"){
  console.log("hello")
    ...
    strokeWeight(0);
    textStyle(NORMAL);
      text("GAME RULES:",250,50)
      textSize(15);
      text("1.There are two players in the game, one is BLACK and another is White.",250,100);
      text("2.If any player pockets Black coin then Black player gets point.",250,150);
      text("3.If any player pockets White coin then White player gets point.",250,200);
      text("4.If any player pockets Red coin that player gets 5 point.",250,250);
      text("5.Whenever player pockets all the coins first they would win the game.",250,300);
